...
import { InstagramLogo, TwitterLogo, TiktokLogo, SoundcloudLogo, SpotifyLogo, AppleLogo, YoutubeLogo, GithubLogo  } from "@phosphor-icons/react";
  ...
  return(
    ...
    <div id="OS">
      ...
      <Grid container spacing={2}> 
        ...
        <div style={{marginLeft:"10%", marginTop:"5%"}}>  
              <ThemeProvider theme={modernDark}>
                <MenuList inline="true" style={{paddingTop:"10px"}}>
                  ...
                  <MenuListItem>
                    <a target="_blank" href="https://github.com/genesisbarrios" style={{textDecoration:"none"}}>
                      <GithubLogo style={{color: '#A6CAF0'}} size={25}></GithubLogo>
                    </a>
                  </MenuListItem>
                </MenuList>
            </ThemeProvider>
        ...
        <Grid item sm={4}>
         <ThemeProvider theme={blue}>
            <Window style={{width:'90%', minHeight: '200px', marginTop:'17%'}}>
                ...
                <WindowContent>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item sm={12} md={6}>
                      ...
                      <Frame style={{marginBottom:"10px", height:"250px", backgroundColor:"white", borderRadius:"15px"}}>
                        <div style={{}}>
                          <img width="80%" height="auto" style={{marginLeft:"10%", marginBottom:"5%"}} src="https://drive.google.com/uc?export=view&id=1frRAuaOWuqEUUYqaYzLB9AdQZvMap58f"></img>
